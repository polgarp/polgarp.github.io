...
[Agents streaming UI is starting to happen](https://peterscontextdesign.substack.com/p/agents-streaming-ui-is-starting-to) by **Peter Van Dijck**

> Christine Vallaure [wrote about](https://uxdesign.cc/a2ui-under-the-hood-designing-for-the-new-era-of-radically-adaptive-ui-cebbf5f32fbe) a new [protocol from Google](https://a2ui.org/) in UXdesign. Basically, if the interface is generated fresh for each request and then thrown away, the unit of design stops being the screen and becomes the system that decides what screen to make — which is context design, not screen design.
...
{% include figure image_path="assets/images/2026-06-21-Streaming-UIs.jpg" caption="A character from the TV show Star Trek: Voyager using an LCARS UI" %}
